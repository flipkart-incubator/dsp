...
public class UpdateDataFrameOverrideAuditRequest extends AbstractDSPServiceRequest<DataFrameOverrideAudit> {

    private final DataFrameOverrideAudit dataFrameOverrideAudit;

    public UpdateDataFrameOverrideAuditRequest(DSPServiceClient client, DataFrameOverrideAudit dataFrameOverrideAudit) {
        super(client);
    ...
    public String getPath() {
        return "/v1/dataframe_override_audits/update";
    }
